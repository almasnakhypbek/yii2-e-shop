                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home() ?>"><?= Html::img('@web/images/home/logo.png', ['alt' => 'Apple Juice'] ) ?></a>
                        </div>
    ...
    <?php
        ...
        \yii\bootstrap\Modal::begin([
            ...
            'footer' => '<button type="button" class="btn btn-default" data-dismiss="modal">Продолжить</button>
                          <a href="' . \yii\helpers\Url::to(['/card/view']) . '" type="button" class="btn btn-success">Оформить заказ</a>
